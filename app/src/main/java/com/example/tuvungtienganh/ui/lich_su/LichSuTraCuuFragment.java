package com.example.tuvungtienganh.ui.lich_su;
...
public class LichSuTraCuuFragment extends ManhVoCoTheTimKiemCau {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        return inflater.inflate(R.layout.fragment_lich_su_tra_cuu, container, false);
    }

    public void taiDuLieu() {
        try {
            mDanhSachCacCauDuocNapTuDuLieuNguon.clear();
            mDanhSachCacCauDuocNapTuDuLieuNguon.addAll(mSql.cacCauDuocGhiVaoLichSuTraCuu());
            ...
            if (!khoiTaoChua()) khoiTao(mTimKiem, mDanhSachCacCauDuocNapTuDuLieuNguon, mDanhSachCacCauDuocTraVeTuKetQuaTimKiem, mCacCauAdapter);
    ...
    public void ganCacKhungNhin() {
        mTimKiem = getView().findViewById(R.id.fragment_lich_su_tra_cuu_tim_kiem);
        mRecView = getView().findViewById(R.id.fragment_lich_su_tra_cuu_danh_sach);
    }
